...
def test_serialization_pipeline(dummy_docs, engine):
    ...
    with tempfile.NamedTemporaryFile(suffix=".yml") as tmp_file:
        ...
        assert config_model_dump["tasks"]["value"][0]["fewshot_examples"]["value"] == ()
        config_model_dump["tasks"]["value"][0]["fewshot_examples"]["value"] = []
        ...
        loaded_pipe = Pipeline.load(tmp_path, ({"engine": {"model": model}},))
