...
class Distillation(Task):
    ...
    def __init__(
        ...
        """Initialize a distillation task.
        ...
        """
        super().__init__(task_id=task_id, include_meta=include_meta, batch_size=-1)
    ...
    def __call__(self, docs: Iterable[Doc]) -> Iterable[Doc]:
        """Distill results in docs for specified target task into local model.

        This will train and save a model in line with the arguments specified at task initialization time.
