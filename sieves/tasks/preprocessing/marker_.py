...
class Marker(Task):
    ...
    def __init__(
        ...
        :param converter: Custom PdfConverter instance. If None, a default one will be created.
        ...
        self._converter = converter or PdfConverter(artifact_dict=create_model_dict())
