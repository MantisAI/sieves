...
Model: TypeAlias = PdfConverter | TableConverter
...
class Marker(Task):
    ...
    def __init__(
        ...
        :param model: Custom PdfConverter instance. If None, a default one will be created.
        ...
        self._converter = model or PdfConverter(artifact_dict=create_model_dict())
